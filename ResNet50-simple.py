...
with open("ResNetClassifier_simple", "w") as json_file:
    json_file.write(model_json)


# serialize weights to HDF5
model.save_weights("ResNetClassifierWeights_simple.h5")
print("Saved model to disk")

# plot model architecture
plot_model(model, show_shapes=True, to_file='ResNet50-architecture234.png')